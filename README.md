...
The project is deployed and can be accessed at [xyz.com]([https://xyz.com](https://roxiler-backend-vijaykumars-projects.vercel.app)). You can use the following APIs to interact with the system.
